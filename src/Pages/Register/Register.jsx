...
export const Register = () => {
    ...
    const handleCreateUserByPassword = (event) => {
            ...
            <div className="hero bg-base-200 min-h-screen">
                <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                    <div className="card-body">
                        <p className='text-center text-2xl my-4'>Register</p>
                        <form onSubmit={handleCreateUserByPassword}>
                            <fieldset className="fieldset">
                                ...
                                <input required type="url" name='photoLink' className="input" placeholder="PhotoUrl" />
